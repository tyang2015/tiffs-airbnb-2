...
My first full-stack project aims to clone the website Airbnb.com -- a popular living-space rental company. It is a full stack project with the core backend functionalities of the original website and near pixel-perfect replica of its UI. All tools/technologies are listed below:
...
You can also delete a spot by clicking "Delete Spot" in the same section above.
