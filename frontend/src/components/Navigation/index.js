...
function Navigation({ isLoaded }){
  ...
  return (
    // <>
    <div className='nav-bar-outer-container' style={{borderBottom:"1px solid rgba(177, 170, 170, 0.3)"}}>
      <ul className='top-nav-bar' style={{listStyle:'none'}}>
        <div className="airbnb-icon-container top-bar" >
            ...
            <NavLink to="/" className="airbnb-main-logo-link-container" style={{textDecoration:'none'}}>
  ...
  {/* changed li to div */}
          <div className= 'inside-nav-bar top-bar' >
